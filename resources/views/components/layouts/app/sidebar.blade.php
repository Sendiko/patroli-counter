    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                <flux:navlist.item icon="clipboard-document-check" :href="route('patrol')"
                    :current="request()->routeIs('patrol')" wire:navigate>
                    {{ __('Patrol Logger') }}
                </flux:navlist.item>

                <flux:navlist.item icon="archive-box" :href="route('found-items')"
